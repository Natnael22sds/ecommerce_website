                    ...
                    <table class="cart-table table table-bordered">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="#"><img src="admin/<?php echo $firstImage; ?>" alt="" height="90" width="90"></a>					
                                </td>
                                <td>
                                    <a href="single.php?id=<?php echo $cartr['id']; ?>"><?php echo substr($cartr['name'], 0, 30); ?></a>					
                                </td>
                                <td>
                                    <span class="amount">Rand <?php echo $cartr['price']; ?></span>					
                                </td>
                                <td>
                        ...
                        <div class="col-md-6 push-md-6 no-padding">
                            ...
                            <table class="table table-bordered col-md-6">
                                <tbody>
                                    <tr>
                                        <th>Cart Subtotal</th>
                                        <td><span class="amount">Rand <?php echo $total; ?>.00/-</span></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th>Order Total</th>
                                        <td><strong><span class="amount">Rand <?php echo $total; ?>.00/-</span></strong> </td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
