...
if(isset($_SESSION["user"])){
    if(($_SESSION["user"])=="" or $_SESSION['usertype']!='Yana'){
            ...
            <li class="nav-item dropdown">
              <a class="nav-link count-indicator" id="messageDropdown" href="#">
                ...
                <?php
                              ...
                              $query = "SELECT id FROM `orders` WHERE usertype='Yana' ORDER BY id";
            ...
            <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                  ...
                  <p class="mb-1 mt-3 font-weight-semibold">Yanaroman car sells</p>
                  <p class="font-weight-light text-muted mb-0">Yanaroman@gmail.com</p>
                </div>
            ...
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                ...
                <div class="text-wrapper">
                  <p class="profile-name">Yanaroman car sells</p>
              ...
              <div class="col-md-12">
                <div class="page-header-toolbar">
                  <div class="btn-group toolbar-item" role="group" aria-label="Basic example">
                    ...
                    <button type="button" class="btn btn-secondary">Payment date - 13/11/2025</button>
